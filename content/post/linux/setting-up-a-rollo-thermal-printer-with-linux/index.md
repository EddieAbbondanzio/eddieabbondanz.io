...
1. Head over to [Rollo's site](https://www.rollo.com/driver-linux/) and download / install the appropriate Linux driver for your distro. (I used the Ubuntu one)
...
4. Download a sample label to test with. [Rollo has one available](https://www.rollo.com/sample/)
5. Open up the sample label and print it. It should just work.
